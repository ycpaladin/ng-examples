...
export class Planet {
  ...
  public get appStatusChange(): Observable<any> { // TODO AppStatusChangeEvent
    return this.planetApplicationLoader.appStatusChange;
  }

  public get appsLoadingStart(): Observable<any> { // TODO AppsLoadingStartEvent
  ...
  start() {
    this.subscription = (this.router.events as Observable<RouterEvent>)
      ...
      .subscribe((url: string) => {
        this.planetApplicationLoader.reroute(url);
      });
  }
